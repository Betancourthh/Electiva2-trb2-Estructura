 ...
 * @author LENOVO
 */
public class frmBucleForEach extends javax.swing.JFrame {

    /**
     * Creates new form frmBucleForEach
     */
    public frmBucleForEach() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnForEach.setText("Definir arreglo de numeros");
    ...
    private void btnForEachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnForEachActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Elementos del arreglo:\n" + resultado.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBucleForEach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBucleForEach().setVisible(true);
            }
        });
    }
